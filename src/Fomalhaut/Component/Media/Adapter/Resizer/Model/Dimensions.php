...
namespace Fomalhaut\Component\Media\Adapter\Resizer\Model;

use Fomalhaut\Component\Media\FomalhautMediaImageResizeTypes;

/**
 * Class Dimensions
 * @package Fomalhaut\Component\Media\Adapter\Resizer\Model
 */
class Dimensions

{
    ...
    public function resolveDimensions(
        ...
        if ($type == FomalhautMediaImageResizeTypes::NO_RESIZE) {
            ...
            FomalhautMediaImageResizeTypes::INSET,
            FomalhautMediaImageResizeTypes::INSET_FILL_WHITE,
            FomalhautMediaImageResizeTypes::OUTBOUNDS_FILL_WHITE,
            FomalhautMediaImageResizeTypes::OUTBOUND_CROP,
        ])) {
            ...
            if ($type == FomalhautMediaImageResizeTypes::OUTBOUND_CROP) {
            ...
            if ($type == FomalhautMediaImageResizeTypes::INSET_FILL_WHITE) {
